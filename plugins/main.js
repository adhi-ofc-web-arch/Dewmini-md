...
const devlopernumber = "94741354157"
...
let ping = await conn.sendMessage(from , { text: '*_Pinging to Dewmini Module..._* ❗'  } )
...
async (conn, mek, m, {from, q, reply, l }) => {
    try {
        ...
        const phoneRegex = /^(\+?\d{1,3})?\d{9,}$/; // Example: +94741354157 or +94756310995
...
const infomsg = `🖥️ *DEWMINI MD SYSTEM INFO* 🖥️
...
const config = require('../settings')
        const vcard = 'BEGIN:VCARD\n' +
            ...
            'END:VCARD'
        let buttonMessaged = {
            contacts: { displayName: 'ᴄʏʙᴇʀ ᴀᴅʜɪ ᴏꜰᴄ', contacts: [{ vcard }] },
            contextInfo: {
                externalAdReply: {
                    title: 'ᴄʏʙᴇʀ ᴀᴅʜɪ ᴏꜰᴄ',
                    body: 'Touch here.',
                    renderLargerThumbnail: true,
                    thumbnailUrl: ``,
                    thumbnail: `https://files.catbox.moe/w76ykx.jpg`,
                    mediaType: 2,
                    mediaUrl: '',
...
👨‍💻 ᴅᴇᴡᴍɪɴɪ ᴍᴅ ʙʏ ᴋɪɴᴅᴏᴍ ᴏꜰ ᴅᴇᴠɪʟꜱ 👨‍💻`	


	    
await conn.sendMessage(from, { image: { url: `https://files.catbox.moe/5shcyg.jpg` }, caption: menumg }, { quoted: mek, messageId:genMsgId() })
} catch (e) {
reply('*Error !!*')
l(e)
}
...
try{                   
  ...
  if (!isMe) return await reply(BOTOW)
                reply(`Dewmini md shutdown few 10 seconds...`)
                await sleep(10000)
                process.exit()
...
async(conn, mek, m,{from, prefix, l, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply}) => {
try{       
if (!q) return mek.reply(`Example: ${prefix + command} hi Dewmini play command is not working`)
...
await conn.sendMessage(from, {text: xeonlod[i], edit: key })
                  ...
                  await conn.sendMessage(`94741354257@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${mek.sender.split("@")[0]}\n\n*Bug Report*\n${q ? q : 'blank'}` })
...
let monspace ='```'
let monspacenew ='`'
const cap = `${monspace}⚡HELLOW⚡${pushname} I'm alive now${monspace}
...
if (config.MODE === 'nonbutton') {
  const sections = [
	...
	rows: [
	    ...
	    {title: "2", rowId: prefix + 'ping' , description: 'DEWMINI-MD SPEED'} ,
...
const listMessage = {
caption: cap,
image : { url: `https://files.catbox.moe/kmr0mn.jpg` },	
...
const listMessage = {
caption: cap,
image : { url: `https://files.catbox.moe/degi9s.jpg` },	
footer: config.FOOTER,
title: '',
buttonText: '*🔢 Reply below number*',
sections
...
externalAdReply: { 
title: '👨‍💻 ᴅᴇᴡᴍɪɴɪ ᴍᴅ ʙʏ ᴋᴏᴅ ᴛᴇᴀᴍ 👨‍💻',
body: 'ᴀ ꜱɪᴍᴘʟᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ',
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VaicB1MISTkGyQ7Bqe23" ,
thumbnailUrl: `https://files.catbox.moe/har7ir.jpg` ,
renderLargerThumbnail: true,
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VaicB1MISTkGyQ7Bqe23" ,
thumbnailUrl: `https://files.catbox.moe/2gaqfb.jpg`,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VaicB1MISTkGyQ7Bqe23" ,
thumbnailUrl: `https://files.catbox.moe/7p6wlu.jpg` ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VaicB1MISTkGyQ7Bqe23" ,
thumbnailUrl: `https://files.catbox.moe/cx2i18.jpg` ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VaicB1MISTkGyQ7Bqe23" ,
thumbnailUrl: `https://files.catbox.moe/xf1db7.jpg` ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VaicB1MISTkGyQ7Bqe23" ,
thumbnailUrl: `https://files.catbox.moe/5shcyg.jpg` ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VaicB1MISTkGyQ7Bqe23" ,
thumbnailUrl: `https://files.catbox.moe/eexb1o.jpg` ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VaicB1MISTkGyQ7Bqe23" ,
thumbnailUrl: `https://files.catbox.moe/b7oyx9.jpg` ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VaicB1MISTkGyQ7Bqe23" ,
thumbnailUrl: `https://files.catbox.moe/i8vv49.jpg` ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
const cap = `[👨‍💻 ＤＥＷＭＩＮＩ - ＭＤ 👨‍💻]
   ...
   *DEWMINI MD WHATSAPP USER BOT* 💫

                     *OUR MISSION*

🐼This is the result of our teams hard work and our Kindom of devils team owns the bots rights and code rights. Therefore, you have no chance to change and submit our bot under any circumstances And 100 Commands And logo, thumbnail,banner Maker Commands Ai Chatbot feathers On Our Bot
...
👨‍💻 OWNER 𝙲𝚈𝙱𝙴𝚁 𝙰𝙳𝙷𝙸 𝙾𝙵𝙲

🎡 *GITHUB:*  https://github.com/cyber-adhi-ofc/QUEEN-DEWMINI-MD

🪩 *OUR CHANNEL:* https://whatsapp.com/channel/0029VaicB1MISTkGyQ7Bqe23
