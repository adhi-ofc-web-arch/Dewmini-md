    ...
    }, 	  
{
    ...
    const listMessage = {
caption: cap,
image : { url: `https://files.catbox.moe/u0ant7.jpg` },	    
footer: 'MOVIE DOWNLOADER BY DEWMINI MD',
...
footer: 'MOVIE DOWNLOADER BY KOD',
title: '',
buttonText: '*🔢 Reply below number*',
sections
}
...
await conn.sendMessage(from, {text: vajiralod[i], edit: key })
        ...
        const message = {
            document: await getBuffer(mediaUrl),
	    caption: "*🎬 DEWMINI MD SUB-DL 🎬*",
            mimetype: "DEWMINI MD SUB DL",
            fileName: `${title}.zip`,
        };
